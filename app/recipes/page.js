    ...
    <>
      <div className="flex flex-col items-center">
        ...
        <div className="flex rounded-md border-2 border-blue-500 overflow-hidden max-w-md mx-auto mt-10">
          <input type="email" placeholder="Search Something..." value={text} onChange={(e) => setText(e.target.value)}
              className="w-full outline-none bg-white text-gray-600 text-sm px-4 py-3" />              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192.904 192.904" width="16px" className="fill-white">
                <path
